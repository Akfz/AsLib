package n.paradox.aslib.mixin.plugin;
    ...
    public void onLoad(String mixinPackage) {
        ...
        if (loader == LoaderEnvironment.Loader.FORGE || loader == LoaderEnvironment.Loader.NEOFORGE) {
            try {
                ...
                System.out.println("[ASLib MixinPlugin] Current Forge FMLEnvironment. Client is : " + isClientEnvironment);
                return;
        ...
        try {
            ...
            Object environmentType = quiltLoaderClass.getMethod("getEnvironmentType").invoke(null);

            isClientEnvironment = environmentType.toString().equals("CLIENT");
            System.out.println("[ASLib MixinPlugin] Current QuiltLoader API. Client is : " + isClientEnvironment);
            return;
        } catch (Exception ignored) {
        }
        ...
        try {
            ...
            isClientEnvironment = environmentType.toString().equals("CLIENT");
            System.out.println("[ASLib MixinPlugin] Current FabricLoader API. Client is : " + isClientEnvironment);
            return;
        } catch (Exception ignored) {}
        ...
        System.out.println("[ASLib MixinPlugin] Current ClassLoader: " + classLoaderName + ". Client is : " + isClientEnvironment);
    }
