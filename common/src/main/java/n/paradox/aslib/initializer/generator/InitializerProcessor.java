...
@SupportedAnnotationTypes("n.paradox.aslib.initializer.generator.GenerateInitializer")
    ...
    public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        ...
        for (Element element : roundEnv.getElementsAnnotatedWith(GenerateInitializer.class)) {
            if (element instanceof TypeElement typeElement) {
                ...
                if (mainClassCanonicalName.equals("n.paradox.aslib.initializer.generator.NotAClass")) {
